  ...
  return (
    <section className="container-fluid my-10">
      ...
      <div className="grid gap-7 my-4 mx-10 sm: grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <div className=" portfolioSlideCard duration-200 flex flex-col bg-lightGray rounded-xl shadow-lg justify-center items-center gap-4 p-2 sm:p-8 hover:scale-105 hover:bg-white">
