...
function Partners() {
  return (
    <div className=" homeOurPartners mt-14 mb-10 py-2 pb-5">
      <div className="title ">
        <h1 className="text-bold text-4xl font-bold text-center my-2 sm:text-4xl md:text-5xl lg:text-5xl text-heading">
      ...
      <div className="flex flex-wrap justify-center gap-5 items-center my-10 mx-5 sm: flex-col md:flex-row lg:flex-row">
        <div className="mx-2">
          <img src="/logo/touchbase.png" alt="" height={200} width={200} />
        </div>
        ...
        <div className="mx-2">
          <img src="/logo/softtech.png" alt="" height={180} width={180} />
        </div>
        <div className="mx-2">
