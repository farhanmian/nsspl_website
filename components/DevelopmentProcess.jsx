...
const DevelopmentProcess = () => {
  return (
    <section className="bg-lightGray py-2 sm:py-5 md:py-10">
      <Heading
      ...
      <div className="flex flex-col gap-6  items-center justify-items-center sm:grid sm:grid-cols-3 justify-center lg:flex lg:flex-row">
        <div className="w-40 h-60 bg-white shadow-lg flex flex-col gap-6 items-center py-4 rounded-3xl lg:mt-28">
        ...
        <div className="w-40 h-60 bg-white shadow-lg flex flex-col gap-6 items-center py-4 rounded-3xl">
